...
class PublicUserApiTests(TestCase):
    ...
    def test_create_valid_user_sucess(self):
        """Test creating a user with valid parameters is successful"""
        payload = {
    ...
    def test_create_user_exists(self):
        """Test creating a user who already exists"""
        payload = {
            'email': 'public@mail.com',
            'password': 'password',
            'name': 'Test Name'
    ...
    def test_password_too_short(self):
        """Test password should be more than 5 character"""
        payload = {
            'email': 'public@mail.com',
            'password': 'pw',
            'name': 'Test Name'
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='user@mail.com', password='testpass')
